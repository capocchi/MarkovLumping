...
if __name__ == '__main__':
    ...
    try:
        ...
        for k,v in methods.items():
            print(f"---------------------- {k}\n")
            avg_waiting_time,avg_service_time,service_rate,abandon_rate = getStat(v(A), True)

            if k == "perron_frobenius":
                QUEUE_WAITING_TIME_M1 = [avg_waiting_time]
                QUEUE_SERVICE_TIME_M1 = [avg_service_time]
                QUEUE_SERVICE_RATE_M1 = [service_rate]
                QUEUE_ABANDON_RATE_M1 = [abandon_rate]
            elif k == "gerschgorin":
                QUEUE_WAITING_TIME_M2 = [avg_waiting_time]
                QUEUE_SERVICE_TIME_M2 = [avg_service_time]
                QUEUE_SERVICE_RATE_M2 = [service_rate]
                QUEUE_ABANDON_RATE_M2 = [abandon_rate]
            elif k == "partial_sum":
                QUEUE_WAITING_TIME_M3 = [avg_waiting_time]
                QUEUE_SERVICE_TIME_M3 = [avg_service_time]
                QUEUE_SERVICE_RATE_M3 = [service_rate]
                QUEUE_ABANDON_RATE_M3 = [abandon_rate]
            elif k == "page_rank":
                QUEUE_WAITING_TIME_M4 = [avg_waiting_time]
                QUEUE_SERVICE_TIME_M4 = [avg_service_time]
                QUEUE_SERVICE_RATE_M4 = [service_rate]
                QUEUE_ABANDON_RATE_M4 = [abandon_rate]
            elif k == "chain_indexing":
                QUEUE_WAITING_TIME_M5 = [avg_waiting_time]
                QUEUE_SERVICE_TIME_M5 = [avg_service_time]
                QUEUE_SERVICE_RATE_M5 = [service_rate]
                QUEUE_ABANDON_RATE_M5 = [abandon_rate]
            else:
                exit()
        ...
        if PLOT:
            ...
            normalized_QUEUE_WAITING_TIME_ORIGINAL = preprocessing.normalize([QUEUE_WAITING_TIME_ORIGINAL])
            normalized_QUEUE_WAITING_TIME_BESTA = preprocessing.normalize([QUEUE_WAITING_TIME_BESTA])
            normalized_QUEUE_SERVICE_TIME_ORIGINAL = preprocessing.normalize([QUEUE_SERVICE_TIME_ORIGINAL])
            normalized_QUEUE_SERVICE_TIME_BESTA = preprocessing.normalize([QUEUE_SERVICE_TIME_BESTA])
            normalized_QUEUE_SERVICE_RATE_ORIGINAL = preprocessing.normalize([QUEUE_SERVICE_RATE_ORIGINAL])
            normalized_QUEUE_SERVICE_RATE_BESTA = preprocessing.normalize([QUEUE_SERVICE_RATE_BESTA])
            normalized_QUEUE_ABANDON_RATE_ORIGINAL = preprocessing.normalize([QUEUE_ABANDON_RATE_ORIGINAL])
            normalized_QUEUE_ABANDON_RATE_BESTA = preprocessing.normalize([QUEUE_ABANDON_RATE_BESTA])

            for k in methods:
                if k == "perron_frobenius":
                    normalized_QUEUE_WAITING_TIME_M1 = preprocessing.normalize([QUEUE_WAITING_TIME_M1])
                    normalized_QUEUE_SERVICE_TIME_M1 = preprocessing.normalize([QUEUE_SERVICE_TIME_M1])
                    normalized_QUEUE_SERVICE_RATE_M1 = preprocessing.normalize([QUEUE_SERVICE_RATE_M1])
                    normalized_QUEUE_ABANDON_RATE_M1 = preprocessing.normalize([QUEUE_ABANDON_RATE_M1])
                elif k == "gerschgorin":
                    normalized_QUEUE_WAITING_TIME_M2 = preprocessing.normalize([QUEUE_WAITING_TIME_M2])
                    normalized_QUEUE_SERVICE_TIME_M2 = preprocessing.normalize([QUEUE_SERVICE_TIME_M2])
                    normalized_QUEUE_SERVICE_RATE_M2 = preprocessing.normalize([QUEUE_SERVICE_RATE_M2])
                    normalized_QUEUE_ABANDON_RATE_M2 = preprocessing.normalize([QUEUE_ABANDON_RATE_M2])
                elif k == "partial_sum":
                    normalized_QUEUE_WAITING_TIME_M3 = preprocessing.normalize([QUEUE_WAITING_TIME_M3])
                    normalized_QUEUE_SERVICE_TIME_M3 = preprocessing.normalize([QUEUE_SERVICE_TIME_M3])
                    normalized_QUEUE_SERVICE_RATE_M3 = preprocessing.normalize([QUEUE_SERVICE_RATE_M3])
                    normalized_QUEUE_ABANDON_RATE_M3 = preprocessing.normalize([QUEUE_ABANDON_RATE_M3])
                elif k == "page_rank":
                    normalized_QUEUE_WAITING_TIME_M4 = preprocessing.normalize([QUEUE_WAITING_TIME_M4])
                    normalized_QUEUE_SERVICE_TIME_M4 = preprocessing.normalize([QUEUE_SERVICE_TIME_M4])
                    normalized_QUEUE_SERVICE_RATE_M4 = preprocessing.normalize([QUEUE_SERVICE_RATE_M4])
                    normalized_QUEUE_ABANDON_RATE_M4 = preprocessing.normalize([QUEUE_ABANDON_RATE_M4])
                elif k == "chain_indexing":
                    normalized_QUEUE_WAITING_TIME_M5 = preprocessing.normalize([QUEUE_WAITING_TIME_M5])
                    normalized_QUEUE_SERVICE_TIME_M5 = preprocessing.normalize([QUEUE_SERVICE_TIME_M5])
                    normalized_QUEUE_SERVICE_RATE_M5 = preprocessing.normalize([QUEUE_SERVICE_RATE_M5])
                    normalized_QUEUE_ABANDON_RATE_M5 = preprocessing.normalize([QUEUE_ABANDON_RATE_M5])
                else:
                    pass
            ...
            # Plot the data on each subplot
            axes[0, 0].plot(X, normalized_QUEUE_ABANDON_RATE_ORIGINAL[0], label="Original")
            ...
            axes[0, 1].plot(X, normalized_QUEUE_SERVICE_RATE_ORIGINAL[0], label="Original")
            ...
            axes[1, 0].plot(X, normalized_QUEUE_SERVICE_TIME_ORIGINAL[0], label="Original")
            ...
            axes[1, 1].plot(X, normalized_QUEUE_WAITING_TIME_ORIGINAL[0], label="Original")
            ...
            # #ax1.plot(X,normalized_kl[0], label="KL", marker="o")
            # ax1.plot(X,normalized_QUEUE_WAITING_TIME_ORIGINAL[0], label="Original", marker=".")
            # ax1.plot(X,normalized_QUEUE_WAITING_TIME_BESTA[0], label="Besta", marker="1")
            # #ax1.plot(X,normalized_QUEUE_WAITING_TIME_M1, label="perron_frobenius", marker="*")
            # ax1.plot(X,normalized_QUEUE_WAITING_TIME_M2[0], label="gerschgorin", marker="o")
            # ax1.plot(X,normalized_QUEUE_WAITING_TIME_M3[0], label="partial_sum", marker=".")
            # ax1.plot(X,normalized_QUEUE_WAITING_TIME_M4[0], label="page_rank", marker="*")
            # ax1.set_title("Average Waiting time")
            # ax1.tick_params(rotation=45)
            # # show a legend on the plot
            # #ax1.legend()
            ...
            # #ax2.plot(X,normalized_kl[0], label="KL", marker="o")
            # ax2.plot(X,normalized_QUEUE_SERVICE_TIME_ORIGINAL[0], marker=".")
            # ax2.plot(X,normalized_QUEUE_SERVICE_TIME_BESTA[0], marker="1")
            # #ax2.plot(X,normalized_QUEUE_SERVICE_TIME_M1[0], marker="*")
            # ax2.plot(X,normalized_QUEUE_SERVICE_TIME_M2[0], marker="o")
            # ax2.plot(X,normalized_QUEUE_SERVICE_TIME_M3[0], marker=".")
            # ax2.plot(X,normalized_QUEUE_SERVICE_TIME_M4[0], marker="*")
            # ax2.set_title("Average Service time")
            # ax2.tick_params(rotation=45)
            # # show a legend on the plot
            # #ax2.legend()
            ...
            # #ax3.plot(X,normalized_kl[0], label="KL", marker="o")
            # ax3.plot(X,normalized_QUEUE_SERVICE_RATE_ORIGINAL[0], marker=".")
            # ax3.plot(X,normalized_QUEUE_SERVICE_RATE_BESTA[0], marker="1")
            # #ax3.plot(X,normalized_QUEUE_SERVICE_RATE_M1[0], marker="*")
            # ax3.plot(X,normalized_QUEUE_SERVICE_RATE_M2[0], marker="o")
            # ax3.plot(X,normalized_QUEUE_SERVICE_RATE_M3[0], marker=".")
            # ax3.plot(X,normalized_QUEUE_SERVICE_RATE_M4[0], marker="*")
            # ax3.set_title("Service Rate")
            # ax3.tick_params(rotation=45)
            # ax3.grid()
            # ax3.set_ylabel("Normalized Amplitude")
            ...
            # #ax4.plot(X,normalized_kl[0], label="KL", marker="o")
            # ax4.plot(X,normalized_QUEUE_ABANDON_RATE_ORIGINAL[0], marker=".")
            # ax4.plot(X,normalized_QUEUE_ABANDON_RATE_BESTA[0], marker="1")
            # #ax4.plot(X,normalized_QUEUE_ABANDON_RATE_M1[0], marker="*")
            # ax4.plot(X,normalized_QUEUE_ABANDON_RATE_M2[0], marker="o")
            # ax4.plot(X,normalized_QUEUE_ABANDON_RATE_M3[0], marker=".")
            # ax4.plot(X,normalized_QUEUE_ABANDON_RATE_M4[0], marker="*")
            # ax4.set_title("Abandon Rate")
            # ax4.tick_params(rotation=45)
            # ax4.grid()
            # ax4.set_ylabel("Normalized Amplitude")

            # ax5.plot(X,normalized_kl[0], label="KL", marker="o")
            # ax5.set_title("KL")
            # ax5.tick_params(rotation=45)
            # ax5.grid()
            # ax5.set_ylabel("Normalized Amplitude")
